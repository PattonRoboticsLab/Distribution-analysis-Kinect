function [correlation,mov1_norm,mov2_norm]= find_correlation(JointMov1, JointMov2, nBins, L, L2)
...
correlation = corr(mov1(:,4), mov2(:,4));
fprintf('correlation is %d', correlation);