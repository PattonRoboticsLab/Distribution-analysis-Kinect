...
% withExo = readtable('/Users/jialinhe1/Desktop/Tesi/Kinect/data/P1/TreatmentSession5/P01_FreeExp5.2.csv', 'NumHeaderLines',1);
% withExopost = readtable('/Users/jialinhe1/Desktop/Tesi/Kinect/data/P1/TreatmentSession5/P01_FreeExp5.3.csv', 'NumHeaderLines',1);

withExo = readtable('/Users/jialinhe1/Desktop/Tesi/Kinect/data/dryrun/Partha/free_exp2_noexo.csv', 'NumHeaderLines',1);
withExopost = readtable('/Users/jialinhe1/Desktop/Tesi/Kinect/data/dryrun/Partha/free_exp3_noexo.csv', 'NumHeaderLines',1);
...
percentile=95;
group1='Exo Pre-therapy';
volume_pre=calc_coverage(withExo_wrist,percentile,group1);
group2='Exo Post-therapy';
volume_post=calc_coverage(withExopost_wrist,percentile,group2);
...
percentile=95;
group1='Pre-therapy';
volume_ja2=calc_coverage(joint_angles2,percentile,group1);
group2='Post-therapy';
volume_ja3=calc_coverage(joint_angles3,percentile,group2);
